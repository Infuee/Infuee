    ...
    <div class="bgBody">
      <div class="banner"> 
          ...
          <div class="banner_content">
              ...
              <h3 style="color: #ffffff; text-transform: capitalize; font-size: 30px; /*font-family: 'Archivo Black'*/, sans-serif;">Order Accepted</h3> 
          </div> 
      </div>
      <div class="content_div">
        <p>Hi {{@$user_info['first_name']}},</p>
        <p>{{@$influencer['first_name']}} {{@$influencer['last_name']}} accepted your order item.</p>
