    ...
    <div class="bgBody">
      <div class="banner"> 
          ...
          <div class="banner_content">
              ...
              <h3 style="color: #ffffff; text-transform: capitalize; font-size: 30px; /*font-family: 'Archivo Black'*/, sans-serif;">Plan Price Setup</h3> 
          </div> 
      </div>
      <div class="content_div">
        <p>Hi {{@$user_info['first_name']}},</p>
        <p>Administrator added a new plan. Please setup price for newly added plan from your infuee profile.</p>
