...
@section('content')
    ...
    <div class="d-flex flex-row">
        ...
        <div class="flex-row-fluid ml-lg-8">
            <form action="{{url('admin/savecategory')}}" method="post" id="category_form" enctype="multipart/form-data" autocomplete="off">
               @csrf
                ...
                <div class="card card-custom card-stretch">
                    ...
                    <div class="card-header py-3">
                        <div class="card-title align-items-start flex-column">
                            <h3 class="card-label font-weight-bolder text-dark">{{@$category['id'] ? "Edit" : "Add" }} Plan Category</h3>
