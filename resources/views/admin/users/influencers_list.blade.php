    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            ...
            <div class="card-toolbar">
                ...
                <!--end::Dropdown-->
                <!--begin::Button-->
                <!-- <a href="{{url('admin/addinfluencer')}}" class="btn btn-primary font-weight-bolder">
                    <span class="svg-icon svg-icon-md">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24"/>
        ...
        <div class="card-body">
            ...
            <div class="mb-7">
                ...
                <form action="{{url('admin/influencers-users')}}">
                            ...
                            <div class="col-md-4 my-2 my-md-0">
                                <div class="d-flex align-items-center">
                                    ...
                                    <select class="form-control" name="status">
                                        ...
                                        <option value="5" {{@$inputs['status'] == 5 ? 'selected' : ''}}>Deleted</option>
                                    </select>
                                </div>
                            </div>
                            {{--<div class="col-md-4 my-2 my-md-0">
            ...
            <div class="table-responsive">
                <table class="datatable datatable-bordered datatable-head-custom" id="influencer_data_listing">
                    <thead>
                    <tr>
                        <th title="ID">ID</th>
                        ...
                        <th title="Instagram Username">Instagram Username</th>
                        <th title="Facebook Username">Facebook Username</th>
                        <th title="Youtube Username">Youtube Username</th>
                        <th title="Tiktok Username">Tiktok Username</th>
                        <th title="Twitter Username">Twitter Username</th>
                        <th title="Created Date">Created Date</th>
                        <th title="Status">Status</th>
                        <th title="Type">Plans</th>
