                ...
                <div class="card-body pt-4">
                    ...
                    <div class="py-9">
                        ...
                        <div class="d-flex align-items-center justify-content-between social-links">
                            ...
                            <span class="text-muted">@if($facebook = $user_->facebook())    
                                <a href="{{$facebook}}" target="_blank"><i class="fa fa-facebook"></i></a>
                            @endif
                            @if($twitter = $user_->twitter())  
                                <a href="{{$twitter}}" target="_blank"><i class="fa fa-twitter"></i></a>
                            @endif
                            @if($pinterest = $user_->pinterest())  
                                <a href="{{$pinterest}}" target="_blank"><i class="fa fa-pinterest-p"></i></a>
                            @endif</span>
                        </div>
                    </div>
                    <!--end::Contact-->
                ...
                <div class="card card-custom card-stretch">
                    ...
                    <!--end::Header-->
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row {{$errors->has('first_name') ? 'has-danger' : ''}}">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <div class="input-group input-group-lg input-group-solid">
                                        ...
                                        <input class="form-control form-control-lg form-control-solid" type="text" name="first_name" value="{{@$user_['first_name']?:old('first_name')}}" {{$page == 'view' ? 'readonly' : ''}} />
                                    </div>
                            ...
                            <div class="form-group row {{$errors->has('last_name') ? 'has-danger' : ''}}">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <div class="input-group input-group-lg input-group-solid">
                                        ...
                                        <input class="form-control form-control-lg form-control-solid" type="text" name="last_name" value="{{@$user_['last_name']?:old('last_name')}}" {{$page == 'view' ? 'readonly' : ''}} />
                                    </div>
                            ...
                            <div class="form-group row {{$errors->has('type') ? 'has-danger' : ''}}">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <select id="type_select" class="form-control" name="type" {{$page == 'view' ? 'disabled' : ''}}>
                                        ...
                                        <option value="1" {{@$user_['type'] == 1 || old('type') == 1 ? 'selected' : ''}} >User</option>
                            ...
                            <div class="form-group row instagram-username {{$errors->has('username') ? 'has-danger' : ''}}" style="{{@$user_['type'] == 2 ? '' : 'display:none'}} ">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <div class="input-group input-group-lg input-group-solid">
                                        ...
                                        <input class="form-control form-control-lg form-control-solid" type="text" name="username" value="{{@$user_['username']?:old('username')}}" {{$page == 'view' ? 'readonly' : ''}}  />
                                    </div>
                            ...
                            <div class="form-group row {{$errors->has('country_code') ? 'has-danger' : ''}}">
                                ...
                                <div class="col-lg-9 col-xl-6">
                                    <div class="input-group input-group-lg input-group-solid country-code_a">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">
                            ...
                            <div class="form-group row {{$errors->has('race_id') ? 'has-danger' : ''}}">
                                ...
                                @if ($errors->has('race_id'))
                                    <div class="fv-plugins-message-container">
                                        <div data-field="race_id" data-validator="notEmpty" class="fv-help-block">
